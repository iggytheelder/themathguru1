  ...
  return (
    <Layout>
      ...
      <p>
        ...
        {' '}<Link href="https://ies.ed.gov/schoolsurvey/spp/">found</Link>{' '}
      ...
      <p>
        You, the Math Guru, show up to your favorite spot (coffee shop, library, etc.) each week, and students show up to get tutoring. You smile, laugh, shake hands with their parents, and work on figuring out how to make math make sense to those kids.
      </p>
      <p>
        That's it. We handle all the rest. You are going to visit your favorite spot anyway. Why not get paid to be there? Together we will solve a global problem with local interactions.
      </p>
      <h3 id = "apply">
        Apply now to join us!
      </h3>
      <p>
        Leave us your info below and we will get in touch with you. Cover letter and resume are optional right now. We want to talk with anyone that is interested in joining! If you have those items, then great, we definitely prefer them. ✌️
      </p>
      <JoinForm></JoinForm>
    </Layout>
  )
